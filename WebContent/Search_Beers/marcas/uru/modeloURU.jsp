        ...
        <div class="row mt-5 mr-5">
            <div style="margin: 0 auto;">
                <div class="form-group">
                    <a href="cervejaUru.jsp">
                        <img class="justify-content-center" src="../../imagens/marcas/Cerveja Norteña.jpg"
                            alt="Cerveja Norteña" height="500">
                    </a>
                </div>
                <p style="text-align: center; margin-left:80px;">Norteña</p>
            </div>
        </div>
    </div>
